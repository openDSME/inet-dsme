...
#include "DSMEMobilityBase.h"

namespace inet_dsme {

using namespace inet::physicalenvironment;

Register_Abstract_Class(inet_dsme::DSMEMobilityBase);
...
DSMEMobilityBase::DSMEMobilityBase() :
...
void DSMEMobilityBase::initialize(int stage)
{
...
void DSMEMobilityBase::initializePosition()
{
    setInitialPosition();
    checkPosition();
    //emitMobilityStateChangedSignal(); // TODO: strange bug when used
    updateVisualRepresentation();
}

void DSMEMobilityBase::setInitialPosition()
{
...
void DSMEMobilityBase::checkPosition()
{
...
void DSMEMobilityBase::initializeOrientation()
{
...
void DSMEMobilityBase::handleMessage(cMessage *message)
{
...
void DSMEMobilityBase::emitMobilityStateChangedSignal()
{
    emit(mobilityStateChangedSignal, this);
}

Coord DSMEMobilityBase::getRandomPosition()
{
    Coord p;
...
bool DSMEMobilityBase::isOutside()
{
...
void DSMEMobilityBase::wrapIfOutside(Coord& targetPosition)
{
    if (lastPosition.x < constraintAreaMin.x || constraintAreaMax.x < lastPosition.x) {
...
void DSMEMobilityBase::placeRandomlyIfOutside(Coord& targetPosition)
{
    if (isOutside()) {
...
void DSMEMobilityBase::raiseErrorIfOutside()
{
    if (isOutside()) {
...
void DSMEMobilityBase::handleIfOutside(BorderPolicy policy, Coord& targetPosition, Coord& speed, double& angle)
{
    switch (policy) {
        case REFLECT:
