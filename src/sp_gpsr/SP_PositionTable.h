 ...
 */
class INET_API SP_PositionTable
{
  private:
    typedef std::tuple<simtime_t, Coord, int> AddressToPositionMapValue;
  ...
  public:
    ...
    void setPosition(const L3Address& address, const Coord& coord, int interfaceId);

    int getInterfaceId(const L3Address& address) const;
    ...
    friend std::ostream& operator << (std::ostream& o, const SP_PositionTable& t);
};
